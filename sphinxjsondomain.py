...
class JSONDomain(domains.Domain):
    ...
    REF_TYPES = {  # type-name -> (URL, tool tip)
        ...
        'boolean': (
            ...
            'Boolean value'),
        'string': ('https://tools.ietf.org/html/rfc8259#section-7',
                   'String'),
        'integer': ('https://tools.ietf.org/html/rfc8259#section-6',
                    'Number (with fractional part)'),
        'float': ('https://tools.ietf.org/html/rfc8259#section-6',
                  'Number (with fractional part)'),
        'null': ('https://tools.ietf.org/html/rfc8259#section-3',
                 'Null value'),
